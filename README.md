...
You print any incomming message even from radio or from rest of the car, forward it (posibly with changed content) before forwarding, drop it or whatever you want.
